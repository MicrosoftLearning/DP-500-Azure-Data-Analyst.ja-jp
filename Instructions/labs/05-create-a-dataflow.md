...
2. 残りのタスクをすべて行って、試用版のセットアップを完了します。
...
作成したら、ワークスペースが開きます。 後の演習では、このワークスペース用のデータフローを作成します。
...
1. **[データ]** ペインで、**Date** テーブルを展開し、**Month Offset Filter** フィールドを横棒グラフのビジュアルにドラッグします。

    ![](../images/dp500-create-a-dataflow-image48.png)

1. **[データ]** ペインで、**Sales** テーブルを展開し、**Sales Amount** フィールドを横棒グラフのビジュアルにドラッグします。
...
1. Month Offset Filter の値を時系列で並べ替えるには、 **[データ]** ペインで **Month Offset Filter** フィールドを選択します。
