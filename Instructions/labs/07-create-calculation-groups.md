...
2.  **アプリケーション ショートカット**のステップで、 **[次へ]** を選択します。


3. **インストールの確認**のステップで、 **[次へ]** を選択します。

4. **[ユーザー アカウント制御]** ポップアップ ウィンドウが表示されたら、 **[はい]** を選択します。
...
4.  **[データ]** ペイン (右側にあります) で、**Sales** テーブルを展開してフィールドを確認します。
...
6.  **[データ]** ペインで、**Sales Amount** フィールドを右クリックし、 **[非表示]** を選択します。

    ![グラフィカル ユーザー インターフェイス、アプリケーション 自動的に生成された説明](../images/image15.png)

7.  **Total Product Cost** フィールドも非表示にします。

8.  **Sales** テーブルが **[データ]** ペインの一覧で最初に表示され、複数の電卓アイコンで修飾されていることに注意してください。
...
20. **[データ]** ペインで、**Time Intelligence** テーブルを展開して開きます。
...
3.  **[データ]** ペインの **Sales** テーブル内から **[値]** ウェルに **Sales** フィールドをドラッグします。

    ![グラフィカル ユーザー インターフェイス、アプリケーション 自動的に生成された説明](../images/image31.png)

4.  **[データ]** ペインの **Time Intelligence** テーブル内から **[列]** ウェルに **Time Calculation** フィールドをドラッグします。
...
### Currency Conversion 計算グループを作成する
...
2.  **[データ]** ペインで、**Currency** テーブルを選択します。
...
13. **[データ]** ペインで、**Currency Conversion** テーブル内の **Converted Currency** フィールドを **[フィルター]** ペインの **[このビジュアルのフィルター]** グループにドラッグします。
